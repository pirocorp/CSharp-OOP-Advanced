namespace P04_WorkForce.Models.Commands
{
    ...
    {
        public CreateEmployeeCommand(JobList jobs, IDictionary<string, IEmployee> employees) 
            : base(jobs, employees)
        {
        }

        public CreateEmployeeCommand(JobList jobs, IDictionary<string, IEmployee> employees, IWriter writer, IEmployeesFactory employeesFactory) 
