namespace CS_OOP_Advanced_Exam_Prep_July_2016.Framework.Lifecycle.Controller
{
    ...
    public class ControllerActionPair
    {
        ...
        /// </summary>
        private readonly IDictionary<int, Type> argumentsMapping;
        ...
        public MethodInfo Action => this.action;

        public object Controller => this.controller;

        public IDictionary<int, Type> ArgumentsMapping => this.argumentsMapping;
    }
}
