...
public class MissionControllerTests
{
    ...
    public void TestInit()
    {
        ...
        this.sut = new MissionController(this.army, this.warehouse);
    }

    [Test]
    public void PerformMissionEnqueueMissionCorrectly()
    {
        //Act
    ...
    {
        var missionController = new MissionController(this.army, this.warehouse);
